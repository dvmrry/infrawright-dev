...
bundle digests, and transferred product-source authority to Go. The current
tree archived executable Node routing, build, CI, and release paths on
2026-07-22; the tag, digest, and frozen fixtures remain provenance only.
