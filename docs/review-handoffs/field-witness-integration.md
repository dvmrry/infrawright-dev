...
- Ambiguity must stay classified instead of being coerced to success: Direct Terraform/provider flag disagreements and acceptance count disagreements become `conflicting`; ambiguous source shapes remain diagnostics.
