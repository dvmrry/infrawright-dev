...
func keyReferenceRawItems() []any {
	return []any{
		map[string]any{"id": json.Number("100"), "name": "SITE_ALPHA", "parent_id": json.Number("0")},
		map[string]any{"id": json.Number("200"), "name": "SITE_BETA", "parent_id": json.Number("0")},
		map[string]any{"id": json.Number("101"), "name": "Shared Segment", "parent_id": json.Number("100")},
		map[string]any{"id": json.Number("201"), "name": "Shared Segment", "parent_id": json.Number("200")},
	}
}
...
func TestAdoptionAndTransformDeriveIdenticalResolvedKeys(t *testing.T) {
	...
	want := []string{
		"site_alpha", "site_alpha_shared_segment",
		"site_beta", "site_beta_shared_segment",
	}
