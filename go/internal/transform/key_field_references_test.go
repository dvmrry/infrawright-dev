...
func locationLikeItems() []any {
	return []any{
		map[string]any{"id": json.Number("100"), "name": "SITE_ALPHA", "parentId": json.Number("0")},
		map[string]any{"id": json.Number("200"), "name": "SITE_BETA", "parentId": json.Number("0")},
		map[string]any{"id": json.Number("101"), "name": "Shared Segment", "parentId": json.Number("100")},
		map[string]any{"id": json.Number("201"), "name": "Shared Segment", "parentId": json.Number("200")},
	}
}
...
func TestKeyFieldReferencesResolveParentNameAndLeaveParentsAlone(t *testing.T) {
	...
	want := []string{
		"site_alpha",
		"site_alpha_shared_segment",
		"site_beta",
		"site_beta_shared_segment",
	}
