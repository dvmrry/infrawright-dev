...
// http_status_error.go ports node-src/collectors/http-status-error.ts: an
...
// node-src/collectors/http-status-error.ts: an error carrying an HTTP
...
// node-src/collectors/http-status-error.ts: it reports the HTTP status
