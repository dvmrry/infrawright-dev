// Package textcompat reproduces Python 3.12/3.13 str.lower() under Unicode Character Database
...
// the original implementation and PYTHON_LOWER_151_RUNTIME_DELTAS in
...
// Ported from inRanges in the original implementation.
...
// the original implementation, keyed the same way (by UCD version, via
...
// isCaseIgnorable ports isCaseIgnorable in the original implementation:
...
// isCased ports isCased in the original implementation: apply the
...
// hasCasedBefore ports hasCasedBefore in the original implementation:
...
// hasCasedAfter ports hasCasedAfter in the original implementation:
...
// pythonLower151 in the original implementation, where
