...
// htmlunescape.go ports the original implementation's
...
// against the real retired source module via esbuild+node during this port; see
// htmlunescape_test.go) is pinned as the differential oracle until the Go
// runtime port is qualified per the Go runtime contract.
...
// the original implementation verbatim. Go's RE2 engine accepts
...
// the original implementation. codepoint is always
...
// HTMLUnescape ports pythonHtmlUnescapeGeneric from
// the original implementation: "Python html.unescape without
